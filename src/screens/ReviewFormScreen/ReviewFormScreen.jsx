                    ...
                    <div style={styles.starContainer}>
                        {[1, 2, 3, 4, 5].map((starValue) => (
                            <IoStar 
                                ...
                                size={36} // Estrellas más grandes
                                style={styles.star(starValue <= formData.rating)}
                                onClick={() => handleRatingChange(starValue)}
                     
                                onMouseEnter={(e) => e.currentTarget.style.color = starValue <= formData.rating ? '#e64a19' : '#616161'}
                                onMouseLeave={(e) => e.currentTarget.style.color = starValue <= formData.rating ? '#ff5722' : '#424242'}
                            />
                        ))}
                         <span style={{...styles.currentRatingText, marginLeft: '15px'}}>({formData.rating} de 5)</span>
                    </div>
                </div>
